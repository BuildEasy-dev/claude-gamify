...
class ClaudeSound {
  ...
  async setTheme(themeName) {
    ...
    this.config.sound_theme = themeName;
    await this.saveConfig();
  }
  ...
  async removeTheme(themeName) {
    ...
    try {
      ...
      if (this.config.sound_theme === themeName) {
        this.config.sound_theme = 'zelda';
        await this.saveConfig();
      }
    } catch (error) {
  ...
  async showQuickStatus() {
    ...
    const theme = this.config.sound_theme;
  ...
  async importConfig(newConfig) {
    ...
    const validKeys = ['sound_theme', 'sound_enabled', 'sound_volume'];
  ...
  async getSystemInfo() {
    ...
    return {
      ...
      audioPlayers,
      currentTheme: this.config.sound_theme,
