...
export class WelcomeScreen {
   ...
   * @param {string} upgradeVersion - Version that was upgraded to (if any)
   */
  static render(updateInfo = null, upgradeVersion = null) {
    console.clear();
    ...
    // Add local upgrade success notice if available
    if (upgradeVersion) {
      welcomeContent += chalk.green(
        `✨ Local installation updated to ${upgradeVersion}\n\n`
      );
    }
