...
import { PromptManager, MenuNavigator } from '../ui/prompts/index.js';
import { 
  MESSAGES, 
  PROMPTS, 
  HOOK_NAMES,
...
export class MenuController {
   ...
   * @param {string} upgradeVersion - Version upgraded to (if any)
   */
  async showMainMenu(updateInfo = null, upgradeVersion = null) {
    const choices = [
    ...
    while (true) {
      await WelcomeScreen.render(updateInfo, upgradeVersion);
